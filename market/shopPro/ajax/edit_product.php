    ...
    <div class="product_wr_edit" id="iki">
      ...
      <div class="edit_product_details" id="product_e" data-id="<?php echo $eproductID;?>">
           ...
           <div class="global_post_box">
                   <div class="price_input_box">
                       <div class="note_market_ed"><?php echo $page_Lang['market_product_price_title'][$dataUserPageLanguage];?></div>
                   ...
                   <div class="price_input_box">
                       <div class="note_market_ed"><?php echo $page_Lang['product_discount_optional'][$dataUserPageLanguage];?></div>
                   ...
                   <div class="price_currency_edit">
                        <div class="note_market_ed"><?php echo $page_Lang['market_currency_optional'][$dataUserPageLanguage];?></div>
                        <div class="input-field col s12">
                            <select id="crncy" class="currency">
                              <option value="" disabled selected><?php echo $page_Lang['market_currency'][$dataUserPageLanguage];?></option>
                              <?php 
							    if($productCurrency){
           ...
           <!--Input STARTED-->
               <div class="global_post_box">
                    <div class="note_market_ed">Product Title</div>
            ...
            <!--Textarea STARTED-->
               <div class="global_post_box">
                   <div class="note_market_ed">Product Description</div>
      ...
      <!--Post Footer STARTED-->
             <div class="post_box_footer">  
                  ...
                  <div class="control right_btn"><div class="share_post_box waves-effect waves-light btn blue save_edit_product"><?php echo $page_Lang['post_share'][$dataUserPageLanguage];?></div></div>
             </div>  
