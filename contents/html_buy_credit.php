      ...
      <div class="create_ads_container">
        <div class="create_ads_box_container closedad">
         <?php if($dataUserCredit > 0){ ?>
          ...
          <div class="create-ads-item-box blue-button" id="sendads" data-type="createadvertise">
           <?php echo $page_Lang['ads_publish'][$dataUserPageLanguage];?></div>
          <?php }else{?> 
          <div class="loadCredit"><?php echo $page_Lang['need_credit'][$dataUserPageLanguage];?></div>
          <?php } ?>
        </div>
      </div>
    </div>
