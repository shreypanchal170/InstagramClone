<?php 
   $betweenProUsers = $Dot->Dot_ProUsersWidget();
   if($betweenProUsers){ 
   $prouserTour = $Dot->Dot_CheckTourSawBefore($uid, 1722) ? '<div style="position:absolute;width:100%;height:100%;z-index:2;" class="tooltipster-punk-preview tooltipstered rmvt" id="tooltipstered1722" data-tip="1722"></div>' : '';
   echo '<div class="bet_youmaynowusers"> '.$prouserTour.'<div class="ymnyt">'.$Dot->Dot_SelectedMenuIcon('pro_member').' '.$page_Lang['pro_members_title'][$dataUserPageLanguage].'</div><span class="showUsersHere"><span class="swiper-container"><span class="swiper-wrapper">';
   foreach($betweenProUsers as $betweenpu){
                   ...
                   <!---->
                      <span class="myNowUserWrp swiper-slide" style="background-image:url('<?php echo $betweenproUserAvatar;?>');">
                          <div class="user_in">
                            <!---->
                            <div class="user_inf">
                               <div class="see_profile hvr-underline-from-left sep" data-type="userfirstinfo" data-id="<?php echo $betweenproUserID;?>">
                                 <div class="sp_i">
