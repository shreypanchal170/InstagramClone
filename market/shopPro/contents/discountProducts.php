<?php  
$AllMarketDiscountedProducts = $DotShopPro->Market_UserMarketDiscountedProducts($marketOwner_id);
if($AllMarketDiscountedProducts){
	echo '<!--2S-->
       <div class="shopPro_wrp">
           <div class="shopPro_opportunity_products">
              <div class="shopPro_discount_title"> '.$page_Lang['our_market_products'][$dataUserPageLanguage].'</div>
               <!--PS-->
                 <div class="swiper-container">
                    <div class="swiper-wrapper">';
	foreach($AllMarketDiscountedProducts as $m_d){
		...
		if($productDiscount){
				  ...
				  $theCurrentPrice = $Dot->Dot_restyle_text($productDiscount). ' ' .$product_Currency;
		...
		<div class="swiper-slide"> 
			   <div class="shopPro_opportunity_product">
				   <div class="shopPro_product_tumbnail">
					  '.$p_editButton.' '.$dis_Percentage.' 
					  <a href="'.$dataPostSlug.'" class="prduct">
					  <img src="'.$final_image.'" /> 
					  </a>
				   </div><a href="'.$dataPostSlug.'" class="prduct">
				   <div class="shopPro_opportunity_product_details">
