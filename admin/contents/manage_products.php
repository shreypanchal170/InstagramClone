   ...
   <div class="global_box_container_users">
        ...
        <div class="divTable blueTable">
            <div class="divTableHeading">
                <div class="divTableRow first_row">
                    ...
                    <div class="divTableHead"><?php echo $page_Lang['see_this_post'][$dataUserPageLanguage];?></div>
                    <div class="divTableHead"><?php echo $page_Lang['user_postt_type'][$dataUserPageLanguage];?></div>
                    <div class="divTableHead"><?php echo $page_Lang['user_postt_time'][$dataUserPageLanguage];?></div>
        ...
        <div class="divTableBody" id="moreType" data-type="user_posts_text">
                ...
                <?php 
				   ...
				   $GetUserPosts = $Dot->Dot_AllUserProductManagement($lastPID);
				   if($GetUserPosts){
					  foreach($GetUserPosts as $userPostData){
						  ...
						  include("html_user_product_posts.php");
					   }
				   }
			   ?>  
            </div>
