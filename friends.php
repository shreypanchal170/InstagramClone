   ...
   <div class="main">
    ...
    <?php 
	   if($ProfilePrivateAccount == '1' && $FriendStatus !=='me' && $FriendStatus !== 'flwr' && $FriendStatus !== 'fri'){
	         echo '<div class="profile_posts_container"><div class="cGcGK_pNo">'.$page_Lang['secret_profile'][$dataUserPageLanguage].'<span class="icons secretAccount_icon"></span></div></div>';
	   }else{
	?>
