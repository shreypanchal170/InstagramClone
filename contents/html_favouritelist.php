<?php   
$visitDataID = $visitoru['fid'];
$visitorUserID = $visitoru['f_user_id'];   
...
<div class="visitor_user_container" data-last="<?php echo $visitDataID;?>">
    <div class="user_w no<?php echo $visitorUserID;?>" style="background-image:url('<?php echo $VisitorUserAvatar;?>');">  
         <div class="user_in">
             <div class="user_inf">
