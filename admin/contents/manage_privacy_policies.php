<div class="page_title bold"><?php echo $page_Lang['manage_privacy_policies'][$dataUserPageLanguage];?></div>
...
<textarea class="changePageTextArea_Page" id="pageCodes"><?php echo stripcslashes($aboutUsDescription);?></textarea>
            ...
            <div class="setting-box">
                   <div class="column-set_input_box">
                       <div class="saveTheSettings btn waves-effect waves-light blue update_page" data-type="aboutusupdate" data-status="privacy_policies"><?php echo $page_Lang['update_page'][$dataUserPageLanguage];?></div>
                   </div>
               </div>
            <!---->
         </div>
